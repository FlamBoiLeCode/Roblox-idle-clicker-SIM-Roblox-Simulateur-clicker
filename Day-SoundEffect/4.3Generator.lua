-- GeneratorsUI.lua V4.3 TikTok
-- LocalScript dans StarterPlayerScripts
-- Features : Base F2 + NumberFormatter (F4.1) + Sons (F4.3)
...
-- F4.1 : Total coins/sec avec NumberFormatter
...
local function createGeneratorRow(genInfo, index)
	...
	-- F4.1 : Production avec NumberFormatter
	...
	-- F4.1 : Coût dynamique avec NumberFormatter
...
-- ===== CRÉER LES 5 LIGNES DE GÉNÉRATEURS =====
