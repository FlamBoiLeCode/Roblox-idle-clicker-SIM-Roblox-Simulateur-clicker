-- PrestigeUI.lua V4.3 TikTok
-- LocalScript dans StarterPlayerScripts
-- Features : Base F3 + NumberFormatter (F4.1) + Sons (F4.3)
...
-- F4.1 : PRESTIGE_THRESHOLD formaté
...
prestigeButton.MouseButton1Click:Connect(function()
	updateInfo()
	prestigeFrame.Visible = not prestigeFrame.Visible
end)

-- F4.3 : Son prestige (uniquement si valide)
